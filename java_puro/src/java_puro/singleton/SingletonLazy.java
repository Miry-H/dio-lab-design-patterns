...
/**
 * A classe SingletonLazy é uma implementação do padrão Singleton com inicialização preguiçosa.
 * Isso significa que a instância única da classe é criada apenas quando é necessária pela primeira vez,
 * economizando recursos até que a instância seja realmente utilizada.
 */
public class SingletonLazy {
     ...
     * Se a instância não existir, ela é criada. Esse método garante que apenas uma instância
     * da classe seja criada (lazy initialization).
     *
